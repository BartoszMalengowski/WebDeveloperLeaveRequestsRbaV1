...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <xsl:template match="/">
        <script src="/prinergyweb/custom/JobInfoSheet/Examples/DefaultWithTabs/include/fleksograf/incDefaultJobInfoSheetJavaScript.js">
        </script>
        <style>
        ...
        <table style="padding-left:15;  margin-bottom:1; ">
            ...
            <td id="StatusProjectOrdered_CSS" class="tooltip" style="padding:5 10 5 10 ;">
                ...
                <span class="tooltiptext" style="padding: 10 10 10 10;">Zamówiono projekt w systemie
                    ...
                    <br/>
                    <br/>Wkrótce otrzymasz od nas plik do akceptacji.
                    <br/>________________________________________________
                    <br/>
                    <br/> Jeżeli zaakceptowałeś już plik do akceptacji to kliknij przycisk
                    <span style="color:gray; font-weight:bold;">Edytuj</span> powyżej, a następnie wypełnij dane z zakładki
                    <span style="color:gray; font-weight:bold;">PROOF</span>.
                </span>
            </td>
        </table>
            ...
            <tbody>
                ...
                <tr>
                    <td align="left">
                        <table border="0" bordercolor="#FF0000" cellpadding="0" cellspacing="0">
                            <tbody>
                                <tr>
                                    <td id="reproTab" align="center" style="background: #E3E3E3; width: 100px; border-left: solid #3F3F3F 1px; border-top: solid #3F3F3F 1px; padding-top: 5px; padding-bottom: 5px">
                                    ...
                                    <td id="proofTab" align="center" style="background: #b8b8b8; width: 100px; border-left: solid #3F3F3F 1px; border-bottom: solid #3F3F3F 1px; border-top: solid #3F3F3F 1px; padding-top: 5px; padding-bottom: 5px">
                                   ...
                                   <td width="600" style="border-bottom: solid dimgray 1px;"></td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
                ...
                <tr>
                    <td>
                        ...
                        <!-- PROJECT SECTION END -->
                        <!-- PROOF SECTION BEGIN -->
                        <div id="proof" style="position: absolute; visibility: hidden; background:#E3E3E3; border-left:1px solid dimgray; height:1500; width:890;">
                            <br/>
                            <table  style="padding-left:10;  margin-bottom:1;">
                                <tr>
                                    <th align="Left" nowrap="true" style="padding:2; ">
